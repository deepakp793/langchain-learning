...
model = ChatOpenAI(model="gpt-5.5-2026-04-23")
...
json_schema = {
    ...
    "properties": {
        "key_theme": {
            ...
            "type": "array",
            "title": "Key Theme",
            "description": "All the key theme of product",
        },
        "summary": {
            "type": "string",
            "title": "Summary",
        ...
        "pros": {
            ...
            "default": None,
            "title": "Pros",
            "description": "Write the pros inside list if abailable",
        },
        "cons": {
            "anyOf": [{"items": {"type": "string"}, "type": "array"}, {"type": "null"}],
            "default": None,
            "title": "Cons",
            "description": "Write the cons inside list if abailable",
        },
        "name": {
    ...
    "required": ["key_theme", "summary", "rating"],
}
